...
/* Private defines -----------------------------------------------------------*/
#define relay_sw_Pin GPIO_PIN_1
#define relay_sw_GPIO_Port GPIOB
#define second_relay_Pin GPIO_PIN_11
#define second_relay_GPIO_Port GPIOB
...
#define Door_sw_Pin GPIO_PIN_6
#define Door_sw_GPIO_Port GPIOB
